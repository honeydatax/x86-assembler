...
nnumber dw 10000,1000,100,10,1

proc number(dword source )
push ds
XOR AX,AX
mov DS,AX
...
proc setvect(word seg,word of,word vector)
push DS
mov AX,0
mov DS,ax
